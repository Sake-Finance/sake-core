    ...
    IAToken
{
    ...
    /// @notice Allows the owner to update the token's name
    /// @param newName The new name for the token
    function updateName(string memory newName) external onlyPoolAdmin {
        _setName(newName);
        emit NameUpdated(newName);
    }

    /// @notice Allows the owner to update the token's symbol
    /// @param newSymbol The new symbol for the token
    function updateSymbol(string memory newSymbol) external onlyPoolAdmin {
